...
stock_data = StockStrategySimulator.get_stock_data(stock_code, interval='monthly', start_date='2000-01-01')
StockStrategySimulator.analyze_stock_data(stock_data)
